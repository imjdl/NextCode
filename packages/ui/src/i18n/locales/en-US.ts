...
const enUS: Record<string, string> = {
  ...
  "occupationOnboarding.modeDescription": "How would you like NextCode to show its work?",
  ...
  "startup.global.silent": "Starting NextCode",
  ...
  "startup.global.servicesFailed":
    "Local data is ready, but app services failed to start. Copy the diagnostics, then exit and reopen NextCode.",
  ...
  "startup.global.starting_services": "Starting NextCode",
  ...
  "startup.global.error.lock_timeout":
    "Waiting for the database write lock timed out. Another NextCode or CLI process may be updating data. Retry after it finishes.",
  ...
  "startup.global.error.startup_status_timeout":
    "No startup status was received. Exit and reopen NextCode. If it fails again, provide the diagnostics to support.",
  "startup.global.error.transport_closed":
    "The preparation process exited or disconnected. Exit and reopen NextCode to check the migration records again.",
  "startup.global.error.unsupported_runtime":
    "The configured Agent does not support storage preparation. Restore the bundled Agent, then reopen NextCode.",
  ...
  "webRemote.addressVirtual": "virtual adapter",
  "webRemote.port": "Port",
  "webRemote.qrAlt": "Phone access QR code",
  ...
  "settings.computerUse.disabledToast":
    "Computer Use is disabled. Existing conversations require a NextCode restart to take effect.",
  ...
  "conversationShare.permission.linkEditorHint": "Import into NextCode",
  ...
  "conversationShare.import.loginRequired":
    "This share cannot be imported anonymously. Sign in to NextCode and try again",
  ...
  // Welcome / Login
  "login.title": "Welcome to NextCode",
  "login.description": "Connect your account to start using NextCode",
  ...
  "logout.confirm.title": "Disconnect and restart NextCode?",
  ...
  "modelTrajectory.empty": "No model calls recorded (only NextCode Agent writes model-io)",
  ...
  "titleBar.menu.help.about": "About NextCode",
  ...
  "forceUpdate.title": "Update NextCode to continue",
  ...
  "workspaceSidebar.unavailableLocalDirectory":
    "The workspace directory does not exist or cannot be accessed. You can only view history for now. Restore the directory and restart NextCode to continue.",
  ...
  // 界面主题选项标签的唯一键族，与 @/themeOptions.ts 的 THEME_OPTIONS 一一对应
  ...
  "settings.terminalFontFamilyDescription":
    "Leave blank to auto-detect system terminal settings; set a value to override the NextCode terminal font.",
  ...
  "settings.migration.sectionDescription":
    "Scan native Claude Code history on this machine, optionally filter by workspace and activity window, then import the selected sessions into their matching NextCode task lists.",
  ...
  "resourceManager.storage.summaryTotal": "Total used by NextCode",
  ...
  "resourceManager.storage.diskUsage": "NextCode uses {used}",
  ...
  "settings.browser.desktopOnly": "Browser data can only be managed in the NextCode desktop app.",
  ...
  "settings.browser.import.helperVerificationFailed":
    "ZCode could not verify its Windows secure import component. Reinstall or update NextCode before importing cookies.",
  ...
  "settings.browser.import.adminConfirmDescription":
    "Chrome protects cookies with App-Bound encryption on Windows. For this import only, NextCode will request administrator access, start a temporary system service, and delete it immediately afterward. Chrome passwords are never read or imported.",
  ...
  "settings.mcp.description": "Manage MCP server configurations used by NextCode Agent.",
  ...
  "settings.mcp.statusOnlyUnsupported":
    "This ZCode Agent cannot refresh OAuth status. Upgrade or restart NextCode, then reopen MCP settings to run a full refresh.",
  ...
  "settings.mcpServers.import.importing": "Importing MCP servers into NextCode",
  ...
  "settings.modelProvider.startPlan.compatibility":
    "Supports BYOK and BYOA. Base URL, API format, and API Key are maintained by NextCode automatically.",
  ...
  "settings.modelProvider.codingPlan.purchase.teamMemberNoticeDescription":
    "Add yourself or other members on the BigModel team plan management page. Once assigned, the team quota will be available in NextCode.",
  ...
  "settings.modelProvider.help.contextWindow":
    "The context capacity the model can process at once, in tokens. NextCode uses this to manage context.\nDo not exceed the model's actual limit.",
  ...
  "settings.usage.billingBanner.description":
    "Connect your {provider} account to query Coding Plan entitlement, then keep coding in NextCode after purchase or setup.",
  ...
  "settings.usage.entitlementServerMcpUsage": "NextCode MCP",
  ...
  "settings.skills.import.mode.symlink.description":
    "Create a directory link to the external agent skill. NextCode follows later source changes, but the skill depends on that source path remaining available.",
  "settings.skills.import.importing": "Importing skills into NextCode",
  ...
  "settings.subagents.description":
    "Manage user-level subagent Markdown files consumed by NextCode Agent.",
  ...
  "settings.plugins.import.mode.symlink.description":
    "Create a directory link to the external agent plugin and register it in plugins.dirs. NextCode follows later source changes, but the plugin depends on that source path remaining available.",
  "settings.plugins.import.importing": "Importing plugins into NextCode",
  ...
  "settings.commands.source.zcodeAgent": "NextCode Agent",
  ...
  "settings.commands.import.mode.symlink.description":
    "Create a file link to the external agent command. NextCode follows later source changes, but the command depends on that source path remaining available.",
  "settings.commands.import.importing": "Importing commands into NextCode",
  ...
  "settingsSync.action.finish": "Start using NextCode",
  "settingsSync.agent.zcode": "NextCode Agent",
  ...
  "onboarding.dialog.title": "Welcome to NextCode",
  ...
  "onboarding.welcome.title": "Welcome to NextCode",
  "onboarding.welcome.start": "Start NextCode",
  ...
  "onboarding.agentsFile.confirmDescription":
    "ZCode will copy {source} to {target}.\nIf the target file already exists, the NextCode default AGENTS configuration will be overwritten.",
  ...
  "chat.placeholder.newTaskMobile": "Ask NextCode anything…",
  ...
  "chat.toolbar.computerUse.tooltip.ready":
    "Computer Use ready — just describe what you want NextCode to do",
  ...
  "chat.toolbar.computerUse.tooltip.error":
    "Computer Use enablement failed. Please restart NextCode app and retry, or ask NextCode to investigate the logs",
  ...
  "workflows.hub.detail.script.note":
    "The script is read-only. To change it, revise it with NextCode in chat and save a new version.",
  ...
  "chat.slash.emptyUnavailable":
    "No slash commands have been broadcast for the current NextCode Agent session",
  ...
  "resourceManager.appUsage": "NextCode",
  ...
  "feedback.submit.template.section.copyErrorHeading": "NextCode Error Info",
  ...
  "offPeak.keepAwakeBanner": "Keep your computer awake while NextCode is running a chat.",
  ...
  "cuaPermission.modal.relaunchAppButton": "Restart NextCode",
  "cuaPermission.modal.relaunchAppHint":
    "Still not working after restarting Helper? Restart NextCode to fully reload the Helper process.",
