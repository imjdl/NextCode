...
const zhCN: Record<string, string> = {
  ...
  "occupationOnboarding.modeDescription": "你希望 NextCode 如何呈现工作过程？",
  ...
  "occupationOnboarding.description": "选择最接近你日常工作的一项，让 NextCode 更懂你的工作。",
  ...
  "occupationOnboarding.memoryDescription": "让 NextCode 记住你的偏好与工作上下文。",
  ...
  "startup.global.silent": "正在启动 NextCode",
  ...
  "startup.global.servicesFailed":
    "本地数据准备已完成，但应用服务启动失败。请复制诊断信息，退出并重新打开 NextCode。",
  ...
  "startup.global.starting_services": "正在启动 NextCode",
  ...
  "startup.global.error.unsupported_runtime":
    "当前配置的 Agent 不支持独立存储准备。请恢复配套的 Agent 后重新打开 NextCode。",
  ...
  "webRemote.addressVirtual": "虚拟网卡",
  "webRemote.port": "端口",
  "webRemote.qrAlt": "手机访问二维码",
  ...
  "settings.computerUse.disabledToast": "电脑控制已关闭，已有对话需重启 NextCode 后生效。",
  ...
  "conversationShare.permission.linkEditorHint": "可导入到 NextCode",
  ...
  "conversationShare.import.loginRequired": "该分享暂不支持匿名导入，请登录 NextCode 后重试",
  ...
  // 登录
  "login.title": "欢迎来到 NextCode",
  "login.description": "连接账号，开始使用 NextCode",
  ...
  "app.login": "连接使用",
  "app.logout": "断开连接",
  "logout.confirm.title": "断开连接并重启 NextCode？",
  ...
  "modelTrajectory.empty": "暂无模型调用记录（仅 NextCode Agent 会落盘 model-io）",
  ...
  "titleBar.menu.help.about": "关于 NextCode",
  ...
  "forceUpdate.title": "需要升级 NextCode 后继续使用",
  ...
  "settings.themeOption.system": "系统",
  ...
  "settings.migration.sectionDescription":
    "扫描本机 Claude Code 原生历史，可按 workspace 和时间范围筛选，再把选中的会话导入到对应的 NextCode 任务列表。",
  ...
  "resourceManager.storage.summaryTotal": "NextCode 总占用",
  ...
  "resourceManager.storage.diskUsage": "NextCode 占用 {used}",
  ...
  "settings.browser.desktopOnly": "浏览器数据只能在 NextCode 桌面端管理。",
  ...
  "settings.mcp.description": "管理 NextCode Agent 使用的 MCP 服务器配置。",
  ...
  "settings.mcp.statusOnlyUnsupported":
    "当前 ZCode Agent 不支持 OAuth 状态刷新。请升级或重启 NextCode，然后重新打开 MCP 设置进行完整刷新。",
  ...
  "settings.mcp.failure.not_authenticated": "当前未登录，请先登录 NextCode。",
  ...
  "settings.mcpServers.import.importing": "正在导入 MCP 服务器到 NextCode",
  ...
  "settings.modelProvider.startPlan.highlight.trial.description": "登录 NextCode 3.x 后开始计时。",
  ...
  "sidebar.usage.plan.zcodeMcpDescription": "NextCode 预置插件 MCP 每日合计额度",
  ...
  "settings.skills.import.importing": "正在导入技能到 NextCode",
  ...
  "settings.plugins.store.subtitle": "用插件为 NextCode 扩展技能、命令与 MCP 能力",
  ...
  "settings.plugins.import.importing": "正在导入插件到 NextCode",
  ...
  "settings.commands.import.importing": "正在导入命令到 NextCode",
  ...
  "onboarding.dialog.title": "欢迎使用 NextCode",
  "onboarding.dialog.description": "选择如何开始第一次会话。",
  "onboarding.wizard.label": "迁移向导",
  "onboarding.welcome.eyebrow": "首次启动设置",
  "onboarding.welcome.title": "欢迎使用 NextCode",
  "onboarding.welcome.start": "开始使用 NextCode",
  ...
  "onboarding.stepDescription.migration": "开始迁移并等待 NextCode 完成导入。",
  ...
  "chat.empty.home": "主目录",
  "chat.placeholder.newTask": "向 NextCode 提问，使用 @ 添加上下文，使用 / 选择命令或能力",
  "chat.placeholder.newTaskMobile": "向 NextCode 提问…",
  ...
  "chat.toolbar.computerUse.tooltip.ready": "电脑操作已就绪 · 直接描述你想让 NextCode 做的事",
  ...
  "workflows.hub.detail.whenToUse.help": "给 NextCode 的路由提示：什么场景该选这个工作流。",
  ...
  "workflows.hub.detail.script.note": "脚本只读。要改脚本，在对话里让 NextCode 修订后另存一版。",
  ...
  "chat.quota.mcp.quotaExhausted": "NextCode MCP「{server}」今日额度已用完，明天自动恢复。",
  ...
  "feedback.submit.template.section.copyErrorHeading": "NextCode 报错信息",
  ...
  "offPeak.keepAwakeBanner": "NextCode 运行会话时保持电脑唤醒。",
  ...
  "cuaPermission.modal.relaunchAppButton": "重启 NextCode",
