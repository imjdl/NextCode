...
function renderWebAuthCallbackPage(): void {
  document.title = "NextCode - Sign In";
...
async function renderConversationSharePage(): Promise<void> {
  ...
  document.title = routeLocale === "zh-CN" ? "NextCode 会话分享" : "NextCode Conversation Share";
...
async function bootstrapWebApp() {
  ...
  try {
    ...
    document.title = "NextCode - Web + Server";
