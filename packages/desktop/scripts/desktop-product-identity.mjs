 ...
 * 可与正式版并排安装的 `NextCode Preview`。
 */
export const ZCODE_PREVIEW_IDENTITY_ENV = "ZCODE_PREVIEW_IDENTITY";

const PRODUCTION_IDENTITY = Object.freeze({
  flavor: "production",
  appId: "dev.nextcode.app",
  productName: "NextCode",
  linuxExecutableName: "nextcode",
  linuxPackageName: "nextcode",
  cuaHelperInstallVariant: null,
});

const PREVIEW_IDENTITY = Object.freeze({
  flavor: "preview",
  appId: "dev.nextcode.app.preview",
  productName: "NextCode Preview",
  linuxExecutableName: "nextcode-preview",
  linuxPackageName: "nextcode-preview",
 ...
 * - `ZCODE_ENV=test` 一律是 Preview，测试后端不能顶着正式 `NextCode` 身份覆盖用户的正式安装；
 ...
 * 生产后端的 Preview 包靠 productName（`NextCode Preview-<version>-...`）与正式包区分。
 */
