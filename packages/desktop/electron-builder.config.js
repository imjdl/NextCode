...
export default {
  ...
  // legacy 工具集（默认）会下载 winCodeSign-2.6.0.7z，其中 darwin/10.12 的
  // libcrypto/libssl 是符号链接；Windows 非管理员或未开开发者模式时 7-Zip 解压
  // 符号链接报“客户端没有所需的特权”，整个打包失败。改用 1.1.0 拆分工具集：
  // rcedit/signtool 按 zip 单独下载（含 sha512 校验），不含符号链接。
  toolsets: {
    winCodeSign: "1.1.0",
  },
  linux: {
