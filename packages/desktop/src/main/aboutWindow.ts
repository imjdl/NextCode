        ...
        <div class="content">
          <div class="app-icon" aria-hidden="true">
            <svg
              ...
              focusable="false"
            >
                            <path fill="currentColor" d="M43.52 0 H85.52 L42 217.6 H0 Z" />
              <path fill="currentColor" d="M85.52 0 H130.61 L170.48 217.6 H125.39 Z" />
              <path fill="currentColor" d="M170.48 0 H212.48 L168.96 217.6 H126.96 Z" />
              <path fill="currentColor" d="M85.52 0 L82.38 15.69 Q85.52 0 91.34 14.9 Z" />
              <path fill="currentColor" d="M170.48 217.6 L164.66 202.7 Q170.48 217.6 167.34 201.91 Z" />
            </svg>
          </div>
